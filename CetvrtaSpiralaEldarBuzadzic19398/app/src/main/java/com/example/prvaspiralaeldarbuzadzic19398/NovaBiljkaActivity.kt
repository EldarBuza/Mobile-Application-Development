...
class NovaBiljkaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dodajBiljku.setOnClickListener{
            ...
            if (!detektovanError){
                ...
                var novaDodanaBiljka = Biljka(nazivT, porodicaT, medicinskoUpozorenjeT, selectedMK, selectedPO, listaJela, selectedKT, selectedZT, false)
                ...
                scope.launch {
                    ...
                    novaDodanaBiljka.onlineChecked = true
                    val rezultat = spasiBiljku(this@NovaBiljkaActivity, novaDodanaBiljka)
                    val tacno: String = "success"
                    when(rezultat){
                        is String -> {setResult(Activity.RESULT_OK)
                        finish()}
    ...
    suspend fun spasiBiljku(context: Context, biljka: Biljka): String?{
